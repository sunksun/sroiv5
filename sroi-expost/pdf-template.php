                        ...
                        <?php foreach ($project_activities_ip as $activity_index => $activity): ?>
                            <tr>
                                ...
                                <td style="border: 1px solid #333; padding: 6px; vertical-align: top; font-size: 10px;">
                                    <?php echo ($activity_index + 1); ?>. <?php echo htmlspecialchars($activity['activity_name']); ?>
                                ...
                                ";
                                    ...
                                    <?php if (!empty($current_outputs)): ?>
                                        <?php foreach ($current_outputs as $output_index => $output): ?>
                                            <strong><?php echo ($output_index + 1); ?>.</strong> <?php echo htmlspecialchars(
                                ...
                                ";
                                    ...
                                    <?php if (!empty($current_outcomes)): ?>
                                        <?php foreach ($current_outcomes as $outcome_index => $outcome): ?>
                                            <strong><?php echo ($outcome_index + 1); ?>.</strong> <?php echo htmlspecialchars(
                    ...
                    <tr>
                        ...
                        if (!empty($available_years)) {
                            foreach ($available_years as $year): ?>
                                <th style="background-color: #cccccc; border: 1px solid #333; padding: 8px; text-align: center; color: #333;"><?php echo htmlspecialchars($year['year_display']); ?></th>
                        <?php
                            endforeach;
                        } else {
